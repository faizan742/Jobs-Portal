...
const emailQueue = new Queue('Receive_Email');
function SendMAil(email) {
  console.log('Send Email');
  console.log(email);
   emailQueue.add({ 
    email: email, subject: 'Received  Email', body:"Your have been CV HAS BEEN RECEIVED FOR CONSIDERRATION  We Will let yoou know very Soon." ,
